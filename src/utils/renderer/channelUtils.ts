...
export class ChannelUtils {
  static getChannelIcon(type: string, customIcon?: string): string {
    ...
    const iconMap: Record<string, string> = {
      ...
      skype: '<svg width="20" height="20" fill="white" viewBox="0 0 24 24"><path d="M12.069 18.874c-4.023 0-5.82-1.979-5.82-3.464 0-.765.561-1.296 1.333-1.296 1.723 0 1.273 2.477 4.487 2.477 1.641 0 2.55-.895 2.55-1.811 0-.551-.269-1.16-1.354-1.427l-3.576-.895c-2.88-.724-3.403-2.286-3.403-3.751 0-3.047 2.861-4.191 5.549-4.191 2.471 0 5.393 1.373 5.393 3.199 0 .784-.688 1.24-1.453 1.24-1.469 0-1.061-2.009-4.005-2.009-1.372 0-2.215.657-2.215 1.657 0 .784.485 1.176 1.268 1.377l2.976.765c3.02.765 3.464 2.356 3.464 3.897-.001 2.054-1.669 4.232-5.194 4.232zm11.084-4.882c-.817 4.653-4.907 8.291-9.874 8.291-.772 0-1.526-.084-2.253-.239-.646.28-1.354.431-2.095.431-2.833 0-5.131-2.298-5.131-5.131 0-.741.151-1.449.431-2.095-.155-.727-.239-1.481-.239-2.253 0-4.967 3.638-9.057 8.291-9.874.646-.28 1.354-.431 2.095-.431 2.833 0 5.131 2.298 5.131 5.131 0 .741-.151 1.449-.431 2.095.155.727.239 1.481.239 2.253 0 .772-.084 1.526-.239 2.253.28.646.431 1.354.431 2.095 0 2.833-2.298 5.131-5.131 5.131-.741 0-1.449-.151-2.095-.431z"/></svg>',
      ...
      chatbot: '<svg width="20" height="20" fill="white" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c1.54 0 3-.35 4.31-.99l3.91 1.01c.39.1.8-.25.7-.64l-1.01-3.91c.64-1.31.99-2.77.99-4.31C22 6.48 17.52 2 12 2zm-2 15l-3-3h2c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4c0 .86.28 1.67.76 2.32L6 14l4 3zm6-7c0-1.1-.9-2-2-2s-2 .9-2 2 .9 2 2 2 2-.9 2-2z"/></svg>',
  ...
  static getChannelColor(type: string): string {
