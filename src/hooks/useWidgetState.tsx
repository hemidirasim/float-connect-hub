...
export const useWidgetState = (user: any) => {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    tooltipPosition: 'top',
    greetingMessage: 'Hi 👋 How can we help you today?', // Set correct default message
    video: null,
    videoUrl: undefined,
    videoType: 'upload',
    videoLink: undefined,
    ...
    try {
      ...
      if (data) {
        ...
        setFormData({
          ...
          greetingMessage: data.greeting_message || 'Hi 👋 How can we help you today?', // Use correct default
          video: null,
  ...
  const resetForm = () => {
    ...
    setFormData({
      ...
      tooltipDisplay: 'hover',
      tooltipPosition: 'top',
      greetingMessage: 'Hi 👋 How can we help you today?', // Use correct default on reset
      video: null,
      videoUrl: undefined,
      videoType: 'upload',
      videoLink: undefined,
