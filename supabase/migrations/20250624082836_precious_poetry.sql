/*
  ...
  1. Changes
    - Ensures only two templates exist: "Modern Clean Template" and "Minimalist"
    - Updates template descriptions and properties
    - Sets default template_id for widgets that don't have one
*/
