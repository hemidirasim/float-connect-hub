...
function generateWidgetScript(widget: any): string {
  ...
  if (config.channels.length === 1 && config.channels[0].type === 'whatsapp') {
    ...
    return `console.log('Loading WhatsApp widget for midiya.az...');
(function() {
  ...
  console.log('WhatsApp widget loaded successfully for midiya.az');
})();`
  }

  // Multi-channel widget
  return `console.log('Loading multi-channel widget for midiya.az...');
(function() {
  ...
  console.log('Widget button added to page for midiya.az');
  ...
  btn.addEventListener('click', function() {
    ...
    console.log('Modal opened for midiya.az');
  ...
  console.log('Multi-channel widget loaded successfully for midiya.az');
})();`
}
