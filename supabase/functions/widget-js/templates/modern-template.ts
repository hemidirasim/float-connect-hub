...
// Import utilities
${await import('./modern/platform-config.ts').then(m => m.default || '')}
${await import('./modern/channel-utils.ts').then(m => m.default || '')}
${await import('./modern/widget-handlers.ts').then(m => m.default || '')}
