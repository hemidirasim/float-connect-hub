...
export const getModernTemplate = (): WidgetTemplate => ({
  ...
  html: `
<!-- Modern Template -->
<div id="hiclient-widget-container" class="hiclient-modern-theme" style="position: fixed; {{POSITION_STYLE}} bottom: 24px; z-index: 99999;">
  
  <!-- Main Button -->
  <div id="hiclient-widget-button" style="width: {{BUTTON_SIZE}}px; height: {{BUTTON_SIZE}}px;">
  ...
  <!-- Tooltip -->
  <div id="hiclient-tooltip" style="{{TOOLTIP_POSITION_STYLE}} display: none;">
    {{TOOLTIP_TEXT}}
  </div>
</div>
...
<div id="hiclient-modal-backdrop">
  <div id="hiclient-modal-content">
    <div id="hiclient-modal-header">
      <h3>{{GREETING_MESSAGE}}</h3>
      <button id="hiclient-modal-close" aria-label="Close">
...
#hiclient-widget-button {
  ...
  overflow: hidden;
  background: linear-gradient(135deg, {{BUTTON_COLOR}}, #764ba2);
}
...
(function() {
  ...
  function generateChannelsHtml() {
    if (!channelsData || channelsData.length === 0) {
      const emptyState = document.getElementById('hiclient-empty-state');
    ...
    function processChannels(channels, isChild = false) {
      channels.forEach(channel => {
        ...
        html += '<a href="' + channelUrl + '" target="_blank" class="hiclient-channel-btn" onclick="window.openChannel && window.openChannel(\\'' + channelUrl + '\\'); return false;">';
  ...
  function getChannelUrl(channel) {
    switch (channel.type) {
      ...
      case 'telegram':
        return channel.value.startsWith('http') ? channel.value : 'https://t.me/' + channel.value.replace('@', '');
      case 'phone':
  ...
  function getChannelIcon(channel) {
    ...
    return icons[channel.type] || '<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>';
  }
